...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0x48, 0x13, 0xF8, 0x05, 0x90, 0x97, 0xA9, 0x4C, 0xA7, 0x95, 0x5E, 0xDD, 0x51, 0x2C, 0x60, 0x8B };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = { 0x62, 0xCC, 0xF8, 0xB0, 0xD3, 0xA9, 0x2A, 0x0D, 0x35, 0xD7, 0xBA, 0x0B, 0x26, 0x6D, 0x1E, 0xCA };

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x260BE402; // <-- Change this address for every node!
...
//    attachInterrupt(1,fire,LOW);  //no connect Flame sensor should commented this code
    ...
    //LMIC_setupChannel(0, 866585000, DR_RANGE_MAP(DR_SF12, DR_SF7),  BAND_CENTI);      // g-band
